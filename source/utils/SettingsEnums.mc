module SettingsEnums {
    ...
    enum /* COMPLICATION_POSITIONS */ {
        COMPLICATION_POSITION_2H = 2,
        COMPLICATION_POSITION_4H = 4,
        COMPLICATION_POSITION_6H = 6,
        COMPLICATION_POSITION_8H = 8,
        COMPLICATION_POSITION_10H = 10,
        COMPLICATION_POSITION_12H = 12
    }

    enum /* COMPLICATION_BAR_POSITIONS */ {
        COMPLICATION_BAR_POSITION_TOP = 0,
        COMPLICATION_BAR_POSITION_BOTTOM = 1
    }

    enum /* COMPLICATION_GRAPH_POSITIONS */ {
        COMPLICATION_GRAPH_POSITION_TOP = 0,
        COMPLICATION_GRAPH_POSITION_BOTTOM = 1
    }
